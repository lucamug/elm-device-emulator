...
var Elm = {};
Elm['SimpleSpa'] = Elm['SimpleSpa'] || {};
if (typeof _lucamug$elm_unbreakable_json$SimpleSpa$main !== 'undefined') {
    _lucamug$elm_unbreakable_json$SimpleSpa$main(Elm['SimpleSpa'], 'SimpleSpa', {"types":{"unions":{"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"SimpleSpa.Msg":{"args":[],"tags":{"SetRoute":["Maybe.Maybe SimpleSpa.Route"]}},"SimpleSpa.Route":{"args":[],"tags":{"Home":[]}}},"aliases":{},"message":"SimpleSpa.Msg"},"versions":{"elm":"0.18.0"}});
}
